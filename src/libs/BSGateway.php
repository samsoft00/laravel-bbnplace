<?php
namespace Samsoft00\Bbnplace\Libs;
/**
...
class BSGateway {
	...
	public $schedule = 0;
	public $sendTime = 0;
	public $sendScheduleNotification = 0;
	public $scheduleName = null;
	public $appid = 0;
	public $callBack = 0;
	public $messageIds = null;
	public $responseString = array ();
	 ...
	 * @return string
	 * $myUsername, $myPassword, $mySender, $myRecipients, $myMessage, $flash = 0, $countrycode=null, $messageid=null
	 */
	public function sendMessage() {
		...
		$this->isflash = ( int ) $this->isflash;
		$this->countryCode = (int)$this->countryCode;
		
		if(!is_null($this->messageid)){
			$this->messageIds = trim($this->messageid);
		}
	 ...
	 * @param int $flash
	 * @return string
	 * $myUsername, $myPassword, $mySender, $myRecipients, $myMessage, $myBroadcastTime, $myScheduleName=null, $notifyMe=0, $flash=0
	 */
	public function scheduleMessage(){
		...
		$this->isflash = (int)$this->isflash;
		$this->schedule = 1;
		$this->sendTime = (int)$this->sendTime;
		$this->scheduleName = (string)$this->scheduleName;
		$this->sendScheduleNotification = (int)$this->sendScheduleNotification;
